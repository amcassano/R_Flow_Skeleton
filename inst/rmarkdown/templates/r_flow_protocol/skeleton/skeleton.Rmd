...
*note from lexi: this function doesn't work, fix and test it*
...
# MMX isn't defined because its above in the live dead formula which couldnt run, define it elsewhere or calculate it again
